...
<div><button><a href="teams.html" target="iframe">Back</a></button></div>
    <h1 style="text-align:center;">BADMINTON TEAMS AND PLAYERS</h1>
<table class="table table-success table-striped">
    ...
    <?php
      $sql="SELECT * FROM accepted WHERE dep='CSE' AND  sport='Badminton'";
...
<table class="table table-success table-striped">
  ...
  <tr>
      ...
      <?php
      $sql="select * from accepted where dep='ECE' and Sport='Badminton'";
 ...
 <tr>
     ...
     <?php
     $sql="select * from accepted where dep='EEE' and Sport='Badminton'";
     $res=mysqli_query($con,$sql);
     while($row=mysqli_fetch_assoc($res)){
     ?>
     <tr>
 ...
 <tr>
     ...
     <?php
     $sql="select * from accepted where dep='CIVIL' and Sport='Badminton'";
     $res=mysqli_query($con,$sql);
     while($row=mysqli_fetch_assoc($res)){
     ?>
     <tr>
 ...
 <table class="table table-success table-striped">
  ...
  <tr>
      ...
      <?php
      $sql="select * from accepted where dep='MEC' and Sport='Badminton'";
      $res=mysqli_query($con,$sql);
      while($row=mysqli_fetch_assoc($res)){
      ?>
      <tr>
