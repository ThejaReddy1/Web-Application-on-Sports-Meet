...
<div><button><a href="teams.html" target="iframe">Back</a></button></div>
    <h1 style="text-align:center;">BASKET BALL TEAMS AND PLAYERS</h1>
...
<table class="table table-success table-striped">
  ...
  <tr>
      ...
      <?php
      $sql="SELECT * FROM accepted WHERE dep='CSE' AND  sport='Basket Ball'";
...
<table class="table table-success table-striped">
  ...
  <tr>
      ...
      <?php
      $sql="select * from accepted where dep='ECE' and Sport='Basket Ball'";
 ...
 <tr>
     ...
     <?php
     $sql="select * from accepted where dep='EEE' and Sport='Basket Ball'";
     $res=mysqli_query($con,$sql);
     while($row=mysqli_fetch_assoc($res)){
     ?>
     <tr>
 ...
 <tr>
     ...
     <?php
     $sql="select * from accepted where dep='CIVIL' and Sport='Basket Ball'";
     $res=mysqli_query($con,$sql);
     while($row=mysqli_fetch_assoc($res)){
     ?>
     <tr>
 ...
 <table class="table table-success table-striped">
  ...
  <tr>
      ...
      <?php
      $sql="select * from accepted where dep='MEC' and Sport='Basket Ball'";
      $res=mysqli_query($con,$sql);
      while($row=mysqli_fetch_assoc($res)){
      ?>
      <tr>
